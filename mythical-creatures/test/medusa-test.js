...
describe('Medusa', function() {
  ...
  it('should have a name', function() {
    ...
    var medusa1 = new Medusa("Dani");
    var medusa2 = new Medusa("Mansour");

    // assert that the first medusa's name is your name
    // assert that the second medusa's name is the other name
    assert.equal(medusa1.name, "Dani");
    assert.equal(medusa2.name, "Mansour");

    //NOTE: We will not ask you to write your own tests in a mod 1 assessment,
    //      but it is good practice to prepare for mod 2!
  });
  ...
  // STOP! Skip down to the bottom of the file and pass the tests for Person
  // and Statue!
